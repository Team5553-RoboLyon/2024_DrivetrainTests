...
#define NLKIN_EPSILON_S			0.00001f	///< 10E-5 m		1 centi�me de mm soit 10 microm�tres
#define NLKIN_EPSILON_V			0.00001f	///< 10E-5 m/s		1 centi�me de mm/s
#define NLKIN_EPSILON_A			0.00001f	///< 10E-5 m/s/s	1 centi�me de mm/s/s
#define NLKIN_EPSILON_J			0.00001f	///< 10E-5 ms/s/s	1 centi�me de mm/s/s/s
#define NLKIN_EPSILON_T			0.0001f		///< 10E-4 s		1 dix milli�me de seconde 
...
*/
#ifdef _NEDITOR
void draw(NL2DOCS * p2docs, const NLKIN *pk0);
#endif
